				...
				<div class="card">
				    <div class="card-header">
				    	<div class="row">
				    		<div class="col-lg-12">
				    			<span>
				    				<button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Leave Type</button>
				    			</span>
				    		</div>
				    		<!-- <div class="col-lg-4">
					            ...
					            <tr>
					             ...
					             <td>
					             	<span style="float: right;">
	     								...
	     								<a href="/delete_leave_type/{{$leave_type->id}}"><button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp; Delete</button></a>
	     							</span>
					             </td>
					            </tr>
				      		@endforeach  
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      <div class="modal-header">
	       ...
	       <div class="modal-body">
	              <form method="POST" action="{{route('admin.leave_type.create')}}">
	              	{{ csrf_field() }}
	                <div class="form-row">
	                	<div class="form-group col-md-12">
