						...
						<li>
							<a href="/admin">
								<div style="margin-top: 20px;" class="row nav_link active_nav">
									...
									<i style="margin-top: 5px;" class="fa fa-inbox" aria-hidden="true"></i>
						...
						<li>
							<div class="row nav_link">
								...
								<ul class="collapse" id="employeeSubmenu">
									<li style="padding-top: 10px;" class="nav_link_li">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div style="list-style: none; padding-top: 25px; font-size: 14px; float: right;">
								<a style="color: #000;" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;{{ __('Logout') }}</a>
